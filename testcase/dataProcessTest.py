...
class DataProcessTest(unittest.TestCase):
    ...
    def testOpenCV(self):
        ...
        dp.processVideoFile('../data/test_data/output/000001/000001/00056_00058.mp4',
                            device='gpu',
        ...
        dp.processVideoFile('../data/test_data/output/000001/000001/00058_00060.mp4',
                            device='gpu',
                            processed_data_root='../data/test_data/pr_data')
        face_path = Path('../data/test_data/pr_data/000001/000001_00058_00060')
        wavfile = Path('../data/test_data/pr_data/000001/000001_00058_00060/audio.wav')
        self.assertTrue(wavfile.exists())
